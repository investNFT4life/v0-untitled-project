  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-5xl mx-auto">
      <div className="flex flex-col justify-center">
        <h3 className="text-2xl font-bold mb-2 text-transparent bg-clip-text hero-gradient">Get in Touch with Us</h3>
        <p className="text-lg mb-6">Questions? Reach out.</p>
